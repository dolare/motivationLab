...
$logo = $borntogive_options['logo_upload'];
$logo_retina = $borntogive_options['retina_logo_upload'];
$logo_sticky = $borntogive_options['logo_upload_sticky'];
$logo_retina_sticky = $borntogive_options['retina_logo_upload_sticky'];
$logo_url = $logo['url'];
...
<header class="topbar">
    	<div class="container">
            <ul class="social-icons topmenu pull-right">
                <?php
					$socialSites = $borntogive_options['header_social_links'];
            ...
            <?php if($borntogive_options['header_info_1_text']!='') { ?>
            ...
            <?php }
			if($borntogive_options['header_info_2_text']!='') { ?>
            <div class="header-info-col">
